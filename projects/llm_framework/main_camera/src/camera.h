...
// #define CONFIG_CAPTURE_HEIGHT  320   // Display height
...
extern "C" {
#endif
typedef void (*vCameraFrameGet)(uint8_t* pData, uint32_t Width, uint32_t Height, uint32_t Length, void *ctx);
...
typedef struct Camera_t {
    ...
    void (*CameraSetCtx)(struct Camera_t*, void *);
} Camera_t;
